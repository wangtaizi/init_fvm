function curvature(G::CellVariable)
	...
	elseif dim == 2
		...
		#ideally should use divergence function but divergence currently returns a FaceVariable
		#the two should be equivalent. This will be a good test for the divergence routine
